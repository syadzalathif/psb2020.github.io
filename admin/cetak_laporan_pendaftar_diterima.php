...
// Data loading
$sql = "SELECT pendaftar.nama_pendaftar, pendaftar.nem, sekolah_asal.nama_sekolah FROM penerimaan INNER JOIN pendaftar ON penerimaan.no_pendaftar = pendaftar.no_daftar LEFT JOIN sekolah_asal ON pendaftar.id_sekolah = sekolah_asal.id WHERE penerimaan.status = 1";
...
// mencetak string
$pdf->Cell(190, 7, 'LAPORAN PENDAFTAR DITERIMA', 0, 1, 'C');
...
$pdf->Cell(190, 7, 'Jumlah Pendaftar Diterima : '.$jml, 0, 1, 'L');
